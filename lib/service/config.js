...
class Config {
  ...
  get chaingreenConfigDirectory() {
    return this.config.chaingreenConfigDirectory;
  }
  ...
  get chaingreenDashboardCoreUrl() {
    return this.config.chaingreenDashboardCoreUrl || 'https://us.chiadashboard.com';
  }
  ...
  get configDirectory() {
    return join(homedir(), '.config', 'chaingreen-dashboard-satellite');
  }
}
